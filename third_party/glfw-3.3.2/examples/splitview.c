...
static void drawAllViews(void) {
	...
	if (height > 0)
		aspect = (float)globalWidth / (float)height;
	else
		aspect = 1.f;
	...
	glViewport(0, height / 2, globalWidth / 2, height / 2);
	glScissor(0, height / 2, globalWidth / 2, height / 2);
	...
	glViewport(0, 0, globalWidth / 2, height / 2);
	glScissor(0, 0, globalWidth / 2, height / 2);
	glMatrixMode(GL_MODELVIEW);
	{
	...
	glViewport(globalWidth / 2, 0, globalWidth / 2, height / 2);
	glScissor(globalWidth / 2, 0, globalWidth / 2, height / 2);
	glMatrixMode(GL_MODELVIEW);
	{
	...
	glViewport(globalWidth / 2, height / 2, globalWidth / 2, height / 2);
	glScissor(globalWidth / 2, height / 2, globalWidth / 2, height / 2);
	glMatrixMode(GL_MODELVIEW);
	{
	...
	if (active_view > 0 && active_view != 2) {
		glViewport(0, 0, globalWidth, height);
...
int main(void) {
	...
	glfwGetFramebufferSize(window, &globalWidth, &height);
	framebufferSizeFun(window, globalWidth, height);
